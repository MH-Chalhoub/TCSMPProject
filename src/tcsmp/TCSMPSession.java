...
public class TCSMPSession {
	...
	public TCSMPSession(String host, int port, String recipient, String sender, String subject, String message, boolean isClient) {
		this.host = host;
		this.port = port;
	...
	public TCSMPSession(String host, String recipient, String sender, String subject, String message, boolean isClient) {
		this(host, 1999, recipient, sender, subject, message, isClient);
	}
